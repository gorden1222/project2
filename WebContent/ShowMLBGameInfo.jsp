...
function update(_data) {
	...
	for(i=0;i<Object.keys(_data).length;i++){
		...
		away_rundiv.setAttribute("style","height: 500px");
		...
		home_rundiv.setAttribute("style","height: 500px");
		...
		home_moneydiv.setAttribute("style","height: 500px");
		...
		total_low_div.setAttribute("style","height: 500px");
